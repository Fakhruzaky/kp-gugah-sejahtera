<nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar min-vh-100 collapse">
  <div class="position-sticky">
    <ul class="nav flex-column">
      ...
      <li class="nav-item">
        <button class="nav-link text-start" style="width: 100%;" type="button" data-bs-toggle="collapse" data-bs-target="#profile-desa" aria-expanded="false" aria-controls="profile-desa">
